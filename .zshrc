...
ZSH_HIGHLIGHT_STYLES[unknown-token]='fg=255,bold,bg=234'
ZSH_HIGHLIGHT_STYLES[comment]='fg=242'
ZSH_HIGHLIGHT_STYLES[command]='fg=255,bold'
ZSH_HIGHLIGHT_STYLES[function]='fg=255,bold'
ZSH_HIGHLIGHT_STYLES[builtin]='fg=254,bold'
ZSH_HIGHLIGHT_STYLES[alias]='fg=254,bold,underline'
ZSH_HIGHLIGHT_STYLES[path]='fg=248'
ZSH_HIGHLIGHT_STYLES[string]='fg=246'
ZSH_HIGHLIGHT_STYLES[single-hyphen-option]='fg=250'
ZSH_HIGHLIGHT_STYLES[double-hyphen-option]='fg=250'
ZSH_HIGHLIGHT_STYLES[redirection]='fg=253'
ZSH_HIGHLIGHT_STYLES[globbing]='fg=251,bold'
source /home/gabriel/.oh-my-zsh/custom/plugins/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
